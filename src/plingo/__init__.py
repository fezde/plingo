...
class Plingo():
    ...
    def _set_command_index(self, index):
        """Defines which of the three channels contains the command and which two others
    ...
    def _cmd_003_invert(self, p1, p2):
        for i in range(3):
            self._output[self._current_y][self._current_x][i] = 255 - self._input[self._current_y][self._current_x][i]
